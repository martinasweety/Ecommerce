    ...
    const infoItems = [
        {
            ...
            title: 'Free Shipping',
            description: 'Get yours orders deliverded with no extra cost',
        },
        {
            icon: <FaHeadset className='text-3xl text-red-600' />,
            title: 'Support 24/7',
            description: 'We are here to assits you anytime',
        },
        {
            icon: <FaMoneyBillWave className='text-3xl text-red-600' />,
            title: '100% Money Back',
            description: 'Full refunds if you are not satisfied',
        },
        {
